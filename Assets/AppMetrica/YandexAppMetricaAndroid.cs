...
public class YandexAppMetricaAndroid : BaseYandexAppMetrica
{
	...
	public override int LibraryApiLevel => _metricaClass.CallStatic<int>("getLibraryApiLevel");

	public override string LibraryVersion => _metricaClass.CallStatic<string>("getLibraryVersion");
