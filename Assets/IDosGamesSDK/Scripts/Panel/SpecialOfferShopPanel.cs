...
namespace IDosGames
{
	public class SpecialOfferShopPanel : ShopPanel
	{
		...
		public static event Action _panelInitialized;
		...
		public override void InitializePanel()
		{
			...
			var playerDataSpecialPurchases = PlayFabDataService.GetPlayerData(PlayerDataKey.special_offer_amount_purchases);
